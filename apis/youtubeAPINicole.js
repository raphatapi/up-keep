...
var ytHead = "https://www.youtube.com/embed/";
	...
	$.ajax({
		...
		for(var i=0; i < newResults.length; i++){
			...
			$("#main-content").append(`<div class="general-video" data-toggle="modal" data-target="#myModal" data-url="${videoURL}"><iframe class="video-iframe" height="400" width="400" src="${videoURL}" allowfullscreen="allowfullscreen"></iframe></div>`);
